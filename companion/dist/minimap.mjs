...
export function renderNotesMinimap({guidance,svg,pack,projection,player,players,trains,activeArea,available,replay,label,mapReady,mapHref}){
  ...
  if(guidance?.segment?.length)svg('polyline',{points:guidance.segment.map(p=>`${p.u*1000},${p.v*1000}`).join(' '),fill:'none',stroke:'#fff','stroke-width':4*scale,class:'route-guide'},layer);
