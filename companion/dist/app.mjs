...
function renderOverlay(){
  ...
  $('mapNotice').hidden=!!projection&&mapReady;$('mapNotice').textContent=!mapReady?'Waiting for the game map. Join a world; if it stays missing, open the in-game paper map.':'Map alignment needed to place players and trains.';
  if(projection){
