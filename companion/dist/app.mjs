...
function renderOverlay(){
  ...
  $('mapNotice').hidden=!!projection&&mapReady;$('mapNotice').textContent=!mapReady?'No map image found. Automatic export is disabled in v0.1.1. See START HERE.txt for using an existing map.':'Map alignment needed to place players and trains.';
  if(projection){
